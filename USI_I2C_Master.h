...
#ifdef I2C_FAST_MODE               // I2C FAST mode timing limits. SCL = 100-400kHz
	//#define T2_I2C    ((SYS_CLK *1300) /1000000) +1 // >1,3us
	//#define T4_I2C    ((SYS_CLK * 600) /1000000) +1 // >0,6us
	#define T2_I2C	1.3		//We'll use the delay.h library _delay_us() function.
	#define T4_I2C	0.6		//We'll use the delay.h library _delay_us() function.
#else                              // I2C STANDARD mode timing limits. SCL <= 100kHz
	//#define T2_I2C    ((SYS_CLK *4700) /1000000) +1 // >4,7us
	//#define T4_I2C    ((SYS_CLK *4000) /1000000) +1 // >4,0us
	#define T2_I2C	4.7		//See fast mode comments.
	#define T4_I2C	4.0
#endif
